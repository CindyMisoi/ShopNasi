...
async function getBuildAction() {
  const mod = await import('./buildAction-a82ec437.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-6b5a6ccd.js');
...
async function getDevAction() {
  const mod = await import('./devAction-1652de84.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-1152e149.js');
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-efcd6e2d.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-2b94f33c.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-20c0b160.js.map
